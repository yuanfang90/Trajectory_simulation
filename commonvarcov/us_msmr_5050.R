...
filename = paste0("/restricted/projectnb/aging-p/yuanf/NP_Trajectories_Clustering/simulation/commonvarcov/us_msmr_5050/simulation_",procid,".csv")
write.csv(t(result),file=filename)

rdname = paste0("/restricted/projectnb/aging-p/yuanf/NP_Trajectories_Clustering/simulation/commonvarcov/us_msmr_5050/simulation_",procid,".RData")
